    ...
    public void onManagerConnected(int status)
    {
        switch (status)
        {
            ...
            case LoaderCallbackInterface.MARKET_ERROR:
            {
                ...
                MarketErrorMessage.getWindow().setType(WindowManager.LayoutParams.TYPE_SYSTEM_DIALOG);
            ...
            case LoaderCallbackInterface.INCOMPATIBLE_MANAGER_VERSION:
            {
                ...
                IncomatibilityMessage.getWindow().setType(WindowManager.LayoutParams.TYPE_SYSTEM_DIALOG);
            ...
            default:
            {
                ...
                InitFailedDialog.getWindow().setType(WindowManager.LayoutParams.TYPE_SYSTEM_DIALOG);
    ...
    public void onPackageInstall(final int operation, final InstallCallbackInterface callback)
    {
        switch (operation)
        {
            case InstallCallbackInterface.NEW_INSTALLATION:
            {
                ...
                InstallMessage.getWindow().setType(WindowManager.LayoutParams.TYPE_SYSTEM_DIALOG);
                InstallMessage.show();
            } break;
            case InstallCallbackInterface.INSTALLATION_PROGRESS:
            {
                ...
                WaitMessage.getWindow().setType(WindowManager.LayoutParams.TYPE_SYSTEM_DIALOG);
                WaitMessage.show();
            } break;
        }
    }
